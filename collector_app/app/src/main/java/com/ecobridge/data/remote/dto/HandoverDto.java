...
public class HandoverDto {
    ...
    @SerializedName("lot_short_code")
    private String lotShortCode;
    ...
    public HandoverDto(String uuid, String referenceNo, String lotId, String lotShortCode, String recyclerId,
        ...
        this.lotId = lotId;
        this.lotShortCode = lotShortCode;
    ...
    public String getLotShortCode() { return lotShortCode; }
    public void setLotShortCode(String lotShortCode) { this.lotShortCode = lotShortCode; }
