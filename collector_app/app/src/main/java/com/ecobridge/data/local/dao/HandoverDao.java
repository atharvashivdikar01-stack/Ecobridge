...
public interface HandoverDao {
    ...
    @Query("UPDATE handovers SET paymentStatus = :paymentStatus, paymentAmount = COALESCE(:paymentAmount, paymentAmount), syncStatus = 'SYNCED' WHERE referenceNo = :referenceNo")
    void applyServerStatus(String referenceNo, String paymentStatus, Double paymentAmount);
