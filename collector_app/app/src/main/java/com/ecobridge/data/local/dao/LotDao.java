...
public interface LotDao {
    ...
    @Query("UPDATE lots SET status = :newStatus, updatedAt = :updatedAt WHERE shortCode = :shortCode")
    void updateLotStatusByShortCode(String shortCode, String newStatus, String updatedAt);
